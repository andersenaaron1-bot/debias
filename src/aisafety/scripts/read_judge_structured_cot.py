"""Print the claim-critical structured-CoT experiment results."""
...
def read_results(
    ...
    *,
    ...
    _print("384-TOKEN ENDPOINTS", endpoint, digits=digits)
    ...
    audit = _read(root, "audit_confirmed_endpoint_effects.csv")
    if not audit.empty:
        audit = audit[
