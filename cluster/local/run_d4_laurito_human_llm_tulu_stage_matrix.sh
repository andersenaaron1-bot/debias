...
# existing Tulu/Llama human-vs-LLM stage matrix on that pair set.
...
RUN_TAG="${RUN_TAG:-laurito_tulu_hllm_stage_v1}"
...
RUN_TAG="$RUN_TAG" \
bash cluster/local/run_d4_human_llm_tulu_stage_matrix.sh
